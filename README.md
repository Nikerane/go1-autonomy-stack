...
- **Previous student:** Nikhil Rane — `nikhil.rane@rwth-aachen.de`
- **Supervisor:** *TBD*
- **Thesis plan (M1–M5):** see the approved plan in `/Users/nikerane/.claude/plans/curious-soaring-cook.md` (private) or [docs/08-next-steps.md](docs/08-next-steps.md) (public-facing version).
- **Credentials:** In this README and [docs/01-hardware.md](docs/01-hardware.md). Keep this repo private until they're rotated.
